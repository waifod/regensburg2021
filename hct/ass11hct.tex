...
\begin{proof}
    ...
    $W$ (Lecture 18). Also, monomorphisms are mapped to Kan fibrations (Lecture
    9) and, for any
    ...
    We can now conclude that $\Fun(k,W)$
    is itself a homotopy equivalence for any $W$ (Lecture 20), hence $k$ is a
